...
class ComputerClusters: UIViewController, UITableViewDelegate, UITableViewDataSource, AVSpeechSynthesizerDelegate {
    ...
    func loadSavedData() {
        // 1
        guard let fileName = Bundle.main.path(forResource: "ComputerClusters" ,ofType: "json")
            else { return }
...
extension ComputerClusters: MKMapViewDelegate {
    //        // 1
...
extension ComputerClusters: CLLocationManagerDelegate {
...
extension ComputerClusters: HandleMapSearch {

...
//  TigerTrail
//
//  Created by Yazan Mimi on 7/8/19.
...
class Create: UIViewController, UITableViewDelegate, UITableViewDataSource, AVSpeechSynthesizerDelegate {
    ...
    var titlebool = false
    var subtitlebool = false
    
    @IBAction func anntitleactionn(_ sender: Any) {
        
//        var ann = mapView.annotations[(mapView.annotations.count - 1)]
////
//        mapView.removeAnnotation(ann)
//
//        let anno = Site(title: "\(anntitle.text ?? "")", locationName: "\(annsubtitle.text ?? "")", discipline: "", coordinate: ann.coordinate)
//
...
//        instructions.isHidden = true
    ...
    @IBAction func annsubtitleaction(_ sender: Any) {
        
//        var ann = mapView.annotations[(mapView.annotations.count - 1)]
//
//
////        for i in 0...(mapView.annotations.count - 1) {
////            if mapView.annotations[i].coordinate.longitude == coordinateto?.longitude {
////                ann = mapView.annotations[i]            }
////
////        }
//
//        mapView.removeAnnotation(ann)
...
//        mapView.selectAnnotation(anno, animated: false)
    ...
    @IBOutlet weak var anntitle: UITextField!
    
    @IBOutlet weak var annsubtitle: UITextField!
    ...
    func loadSavedData() {
//        // 1
//        guard let fileName = Bundle.main.path(forResource: "Create" ,ofType: "json")
//            else { return }
...
//        let rev = ReversedGeoLocation(with: CLPlacemark(location: CLLocation(latitude: newCoordinates.latitude, longitude: newCoordinates.longitude), name: "", postalAddress: CNPostalAddress()))
    ...
    func addAnnotationhelper(coordinates : CLLocationCoordinate2D, title : String, subtitle : String) {
        ...
        let ann = Site(title: "\(title)", locationName: "\(subtitle)", discipline: "", coordinate: coordinates)
...
extension Create: MKMapViewDelegate {
    //        // 1
...
extension Create: CLLocationManagerDelegate {
...
extension Create: HandleMapSearch {

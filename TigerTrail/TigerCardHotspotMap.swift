...
class TigerCardHotspotMap: UIViewController, UITableViewDelegate, UITableViewDataSource, AVSpeechSynthesizerDelegate {
    ...
    func loadSavedData() {
        // 1
        guard let fileName = Bundle.main.path(forResource: "Hotspots" ,ofType: "json")
            else { return }
...
extension TigerCardHotspotMap: MKMapViewDelegate {
    //        // 1
...
extension TigerCardHotspotMap: CLLocationManagerDelegate {
...
extension TigerCardHotspotMap: HandleMapSearch {
